...
class dLinUCB:
    def __init__(self, dimension, alpha, lambda_, NoiseScale, tau, delta_1 = 1e-2 , delta_2 = 1e-1, tilde_delta_1 =0.2*1e-2, init="zero"):  # n is number of users
        ...
        self.eta = math.sqrt(2.0)*(self.NoiseScale**2)*erfinv(1.0 -self.delta_1 )
